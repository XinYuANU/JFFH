...
URnet = require 'adverserial_xin_v1_D_revise_perception_triplet'
...
opt = lapp[[
  -s,--save          (default "logs_Triplet_newest")      subdirectory to save logs
...
if opt.network == '' then
	...
	local d3 = {d2, e3} - nn.JoinTable(2, 4) - nn.SpatialUpSamplingNearest(2) - stn_L3(128+512) - cudnn.SpatialConvolution(128+512, 320, 3, 3, 1, 1, 1, 1) - cudnn.SpatialBatchNormalization(320) - cudnn.ReLU(true)-- 8
	local d4 = {d3, e2} - nn.JoinTable(2, 4) - nn.SpatialUpSamplingNearest(2) - stn_L4(128+320) - cudnn.SpatialConvolution(128+320, 512, 3, 3, 1, 1, 1, 1) - cudnn.SpatialBatchNormalization(512) - cudnn.ReLU(true) -- 16
	local d5 = {d4, e1} - nn.JoinTable(2, 4) - nn.SpatialUpSamplingNearest(2) - stn_L5(512+32) - cudnn.SpatialConvolution(512+32, 256, 3, 3, 1, 1, 1, 1) - cudnn.SpatialBatchNormalization(256) - cudnn.ReLU(true)  --32
